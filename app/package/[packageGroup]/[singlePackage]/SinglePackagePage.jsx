        ...
        return (
            <>
                <div style={{ background: 'white', width: '100%' }}>
                    ...
                    <div style={{ background: "black", padding: '5%', display: 'flex', justifyContent: 'space-between' }}>
                        <div>
                            <h4 style={{ fontSize: '15px', color: "rgba(255,255,255,.7)", textDecoration: 'line-through' }}>{data.price}</h4>
                        ...
                        <div className='rounded-2xl' style={{ padding: "3px 12px", background: "var(--primary)", color: 'black', display: 'flex', justifyContent: 'center', alignItems: 'center', height: 'fit-content', fontWeight: 'bold', borderRadius: 20 }}>
                            <h4 style={{ fontSize: 16 }}>Save 30%</h4>
                        </div>
                    </div>
                    <div style={{ padding: '5%' }}>
                        {/* <p className='bg-gray-200' style={{ fontWeight: '800', color: "var(--primaryColor)", fontSize: 20, marginBottom: 5 }}><FaTags /> Without Hotel</p> */}
