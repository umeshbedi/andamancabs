        ...
        <div
            ...
            >
                <div style={{ width: mobile() ? "100%" : "15%", display: 'flex', justifyContent: 'center', marginBottom: mobile() ? "1.5rem" : null }}>
                    <div style={{ width: mobile() ? 200 : 150, position: 'relative', height: mobile() ? 200 : 150 }}>
                ...
                <div style={{ width: mobile() ? "100%" : "25%", flexDirection: 'column', display: "flex", justifyContent: 'space-between', borderLeft: mobile() ? null : "1px solid #e2e8ee", marginTop: mobile() ? "2.5rem" : null }}>
                    ...
                    <div style={{ height: "3rem", width: '100%', background: "var(--primary)", marginTop: "1.5rem", display: 'flex', alignItems: "center", justifyContent: 'center', cursor: 'pointer', borderRadius: mobile() ? 50 : null }}
                        onClick={() => {
                            setOpen(true);
                            setActivityDetails({
                                name: title,
